...
public class TrashRetrieveController {
	
	@Autowired
	AddressService service;
	
	@GetMapping("trashList.do")
	public String addressList(
		...
		List<AddressVO> addressList = service.retrieveTrashList(paging);
		...
		return "tiles:groupware-member/addressBook/addressBook-trash";
		
	}
	
	@GetMapping("trashDetail.do")
	public String trashDetail(
		...
		return "groupware-member/addressBook/trashDetail";
	}
