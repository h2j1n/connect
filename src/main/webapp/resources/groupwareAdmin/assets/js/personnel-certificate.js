...
$(function () {
  ...
  if (dt_filter_table.length) {
    ...
    var dt_filter = dt_filter_table.DataTable({
      ajax: {
		url: contextPath + '/gw/cerificateList',
		dataSrc: 'data' // dataSrc 설정 추가
	  },
      columns: [
        { data: 'certIssNo' },
        { data: 'certIsscon' },
      ...
      columnDefs: [
        {
            ...
            render: function (data, type, full, meta) {
              var $certNo = full['certNo'];
              // Creates full output for row
              var $row_output =
                '<a href="javascript:void(0);" id="cert'+$certNo+'" class="text-heading text-truncate"><i class="bx bx-printer"></i> 프린트</a>'
              return $row_output;
            }
        }
      ],
