...
//         document.getElementById('current-time').innerText = now; // HTML에 현재 시간을 삽입
//       } catch (e) {
//         console.error('Error setting locale or formatting date:', e);
//       }
...
(function () {
  ...
  if (typeof i18next !== 'undefined' && typeof i18NextHttpBackend !== 'undefined') {
    i18next
      ...
      .init({
        lng: window.templateCustomizer ? window.templateCustomizer.settings.lang : 'ko',
        debug: false,
        fallbackLng: 'ko',
        backend: {
