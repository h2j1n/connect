<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <section class="find m-auto" id="sectionPath" data-cpath="${cPath }">
    <form method="post">
        <h1 class="h3 pc fw-bold wow fadeInDown mb-4"><span>비밀번호 찾기</span></h1>
        <h1 class="h3 mo fw-bold wow fadeInDown mb-4">비밀번호 찾기</h1>
        ...
        <ul class="d-flex align-items-center justify-content-between wow fadeInUp my-3" data-wow-delay=".4s">
            <li>
                <a href="${cPath }/w/member/idFind.do">아이디 찾기</a>
            </li>
        </ul>
        <div class="button wow fadeInUp" data-wow-delay=".6s">
            <button class="btn w-100 py-2" id="pwFindBtn" type="submit" >완료</button>
        </div>
    </form>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">회원 비밀번호 찾기</h1>
...
<script type="text/javascript" src="${cPath }/resources/js/app/jhjTa/web/memberFindPw.js"></script>