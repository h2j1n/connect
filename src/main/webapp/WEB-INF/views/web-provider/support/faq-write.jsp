...
<div class="container-xxl flex-grow-1 container-p-y blog-single ">
    <div class="py-4 mb-6 ">
        <div class="demo-inline-spacing pb-5">
            <a href="event.html" type="button" class="btn rounded-pill btn-outline-primary">
                ...
                <form class="card-body">
                    ...
                    <div class="row">
                        <div class="mb-4 col-md-6">
                            <label for="proceed" class="form-label">진행방식</label>
                        ...
                        <div class="mb-4 col-md-6">
                            <label for="entry" class="form-label">모집여부</label>
                            <select class="form-select" id="entry" aria-label="Default select example">
                    ...
                    <div class="row">
                        <div class="mb-4 col-md-6">
                            <label for="event-start" class="form-label">이벤트 시작일시</label>
                            <input class="form-control" type="datetime-local" value="2024-02-01T00:00:00" id="event-start">
                        </div>
                        <div class="mb-4 col-md-6">
                            <label for="event-end" class="form-label">이벤트 종료일시</label>
                            <input class="form-control" type="datetime-local" value="2024-09-23T12:00:00" id="event-end">
                        </div>
                    </div>
                    <div class="row p-2">
