			...
			<div class="col app-email-sidebar border-end flex-grow-0"
				...
				<div class="email-filters pt-4 pb-2 ps">
					...
					<ul class="email-filter-folders list-unstyled">
						...
						<li class="d-flex mb-1 active"><a href="${cPath }/gw/board/trash.do"
							class="d-flex flex-wrap align-items-center"> <i
										...
										<div class="d-flex align-items-center w-100">
											...
											<div
												...
												<small class="email-list-item-time text-muted"
													...
													<li class="list-inline-item email-delete btn btn-icon"  data-adr-no="${board.grbNo}" 
		   												 data-emp-no="${empNo}" 
		   												 data-trash-no="${board.grbTrashList[0].trashNo }"onclick="permanentDelete(this)">
		   												 <i class="bx bx-trash bx-md"></i>
												  </li>
													</c:if>
												<li class="list-inline-item email-unread btn btn-icon" data-emp-no="${empNo}" data-adr-no="${board.grbNo}"onclick="toggleTrashN(this)">
