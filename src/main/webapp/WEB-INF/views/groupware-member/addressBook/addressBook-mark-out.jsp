                   ...
                   <div class="card-body emails-list-header p-3 py-2">
                       ...
                       <div class="d-flex justify-content-between align-items-center ps-1">
                           <div class=" d-flex align-items-center btn-group" role="group" aria-label="Basic example">
							    <a href="${cPath}/gw/address/addressBookMarkList.do" class="btn btn-label-secondary ">
							        <i class='bx bxs-star pe-1'></i> 
							        즐겨찾기
							    </a>
							    <a href="${cPath}/gw/address/addressMarkList.do" class="btn btn-label-secondary active">
                               ...
                               <thead>
								...
								<tbody class="table-border-bottom-0">
									<c:choose>
										...
										<c:otherwise>
											<tr>
												<td colspan="6">즐겨찾기된 외부연락처가 없습니다.</td>
											</tr>
										</c:otherwise>
									</c:choose>
