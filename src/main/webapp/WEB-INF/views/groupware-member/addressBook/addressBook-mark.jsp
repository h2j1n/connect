               ...
               <!-- addr Filters -->
                                <div class="addr-filters pt-4 pb-2 overscoll">
                                    <ul class="addr-filter-folders list-unstyled">
                                        ...
                                        <li class="active d-flex justify-content-between mb-1" >
               ...
               <div class="card shadow-none border-0 rounded-0">
                   <div class="card-body emails-list-header p-3 py-2">
                                       ...
                                       <!-- Search Form -->
										<div id="searchUI">
											...
											<form:input type="text"
												...
												placeholder="직원을 검색하세요." aria-label="직원을 검색하세요."
                       ...
                       <div class="d-flex justify-content-between align-items-center ps-1">
                           <div class=" d-flex align-items-center btn-group" role="group" aria-label="Basic example">
							    <a href="${cPath}/gw/address/addressBookMarkList.do" class="btn btn-label-secondary active">
							        <i class='bx bxs-star pe-1'></i> 
							        즐겨찾기
							    </a>
							    <a href="${cPath}/gw/address/addressMarkList.do" class="btn btn-label-secondary">
							        <i class='bx bxs-user-pin pe-1'></i> 
							        외부연락처
							    </a>
							</div>
												...
												<tr>
								                    ...
								                    <form>
														    <td>
										                        <label for="bookmark-${bookmark.markNo}" class="btn btn-icon rounded-pill btn-outline-warning">
										                            <input type="hidden" name="bookmark" class="bookmark-checkbox" data-mark-no="${bookmark.markNo}" />
										                            <input type="hidden" name="empNo"  data-emp-no="${bookmark.employee.empNo}" />
										                            <c:choose>
										                                <c:when test="${not empty bookmark.markNo}">
										                                    <i class='bx bxs-star' data-mark-no="${bookmark.markNo}" data-emp-no="${bookmark.employee.empNo}"  onclick="toggleBookmark(this)"></i>
										                                </c:when>
										                                <c:otherwise>
										                                    <i class='bx bx-star' data-mark-no="${bookmark.markNo}" data-emp-no="${bookmark.employee.empNo}"  onclick="toggleBookmark(this)"></i>
										                                </c:otherwise>
										                            </c:choose>
										                        </label>
										                    </td>
													...
													<td>
														    <div class="d-flex justify-content-start align-items-center user-name">
														    	<c:choose>
																	<c:when test="${not empty bookmark.employee.empProfile}">
																		<!-- 프로필 사진이 있을 경우 -->
																		
																		<div class="avatar-wrapper emp-info" data-emp-no="${bookmark.employee.empNo}" data-target='#app-addr-contacts'>
														                    <div class="avatar me-2">
														                    	<c:url value='/files/${bookmark.employee.atchFile.fileDetails[0].streFileNm}' var="fileUrl"/>
														        ...
														        <div class="d-flex flex-column">
														            <span class="emp_name text-truncate">${bookmark.employee.empNm}</span>
														            <small class="emp_post text-truncate text-muted">
														                <span class="badge bg-label-primary me-1">${bookmark.employee.empState}</span>
