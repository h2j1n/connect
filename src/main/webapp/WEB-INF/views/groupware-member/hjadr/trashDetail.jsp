...
<div
	...
	<span> <b>${address.adrAff}</b> / <b>${address.adrPos}</b>
	</span>
</div>
			...
			<div class="modal fade" id="delModal" tabindex="-1"
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<form action='<c:url value="/address/trashDelete.do" />'
			...
			<div class="modal fade" id="restoreModal" tabindex="-1"
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<form action='<c:url value="/address/trashRestore.do" />'
							id="deleteForm" method="get">
							<input type="hidden" name="what" value="${address.adrNo}">
							<div class="modal-footer">
								<button type="button" class="btn btn-label-success"
									data-bs-dismiss="modal">취소</button>
								<button type="submit" id="delete" class="btn btn-danger">복구하기</button>
							</div>
						</form>
					</div>
				</div>
